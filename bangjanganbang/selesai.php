                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="container pb-4">
                                                                    ...
                                                                    <div class="row pt-4">
                                                                        <div class="col-auto">
                                                                            <img src="../<?= $dt["img"] ?>" alt="details" height="80" width="80">
                                                                        </div>
                                                                        <div class="col-4" style="text-align:left ">
                                                                            <?= $dt["nama_barang"] ?>
                                                                        </div>
                                                                        <div class="col-1"style="text-align:left ; margin-left:40px">
                                                                            <?= $dt["qty"] ?>
                                                                        </div>
                                                                        <div class="col">
                                                                        ...
                                                                        ?>
                                                                            <div class="row mt-3">
                                                                                <div class="col">
                                                                                    <div class="container p-4 pt-2" style="background-color: white ; text-align:left ; box-shadow: 1px 4px 15px rgba(0, 0, 0, 0.1); border-radius:8px ">
                                                                                        <p><?= $dt["ulasan"] ?></p>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                ...
                <footer class="py-4 bg-light mt-auto">
                    <div class="container-fluid px-4">
                        <div class="d-flex align-items-center justify-content-between small">
                            <div class="text-muted">Copyright &copy; Tekno</div>
                            <div>
